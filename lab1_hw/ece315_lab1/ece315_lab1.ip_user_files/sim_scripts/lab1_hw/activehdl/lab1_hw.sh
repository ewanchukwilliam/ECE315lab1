...
#                script (type 'lab1_hw.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/wewanchu/School/ECE315/lab1/ECE315lab1/lab1_hw/ece315_lab1/ece315_lab1.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
