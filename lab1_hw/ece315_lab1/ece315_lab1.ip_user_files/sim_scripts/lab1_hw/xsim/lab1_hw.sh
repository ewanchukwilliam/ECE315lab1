...
#
# Script generated by Vivado on Thu Feb 05 14:00:16 -0700 2026
...
#
# Usage        : lab1_hw.sh
#                lab1_hw.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                lab1_hw.sh [-reset_run]
#                lab1_hw.sh [-reset_log]
#                lab1_hw.sh [-help]
#
...
# script info
echo -e "lab1_hw.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./lab1_hw.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb lab1_hw.wdb xsim.dir libdpi.so)
...
Usage: lab1_hw.sh [-step]\n\
Usage: lab1_hw.sh [-lib_map_path]\n\
Usage: lab1_hw.sh [-reset_run]\n\
Usage: lab1_hw.sh [-reset_log]\n\
Usage: lab1_hw.sh [-keep_index]\n\
